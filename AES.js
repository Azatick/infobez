...
class AesCtr extends Aes {
    ...
    static encrypt(plaintext, password, nBits) {
        ...
        for (let b=0; b<blockCount; b++) {
            ...
            const textBlock = this.getBytesArray(plaintext.slice(b*blockSize, (b+1)*blockSize), 16)

            const cipher = Aes.cipher(textBlock, keySchedule);  // -- encrypt counter block --
    ...
    static getBytesArray (input, size) {
...
const encr = AesCtr.encrypt('Azat!', '5656', 128);
