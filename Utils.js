...
/**
 * Возвращает число r раундов
 * @param {bytesCount} m Размер ключа
 * @param {bytesCount} q Размер блока
 * @returns {number} r Число раундов
 */
function getNumRound(m, q) {
    var table = {
        16: {
            16: 10,
            24: 12,
...
function getInvSBoxValue(n) {
    return invSBox[n];
}
exports.getInvSBoxValue = getInvSBoxValue;
...
function getRConValue(a, b) {
    return rCon[a][b];
}
exports.getRConValue = getRConValue;
function utf8Encode(input) {
    return querystring_1.unescape(encodeURIComponent(input));
}
exports.utf8Encode = utf8Encode;
function utf8Decode(strUtf) {
    return decodeURIComponent(querystring_1.escape(strUtf));
}
