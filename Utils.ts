...
export type bytesCount = 16 | 24 | 32;
 ...
 */
export function getNumRound (m: bytesCount, q: bytesCount) {
    const table = {
        16: {
            16: 10,
            24: 12,
...
export function getInvSBoxValue (n: number) {
    return invSBox[n]
}
...
export function getRConValue (a: number, b: number) {
    return rCon[a][b]
}
